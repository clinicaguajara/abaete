...
def render_main_layout():
    ...
    # Cria duas colunas: uma para a ação principal (login/cadastro) e outra para a recuperação de senha
    col_auth, col_reset = st.columns([2, 1])  # Por exemplo, a coluna de login fica maior
    ...
    with col_reset:
        # O botão de Recuperar Senha será exibido sempre na coluna dedicada, independente do estado de processamento
        if option == "Login":
